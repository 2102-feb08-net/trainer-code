...
namespace RestaurantReviews.ConsoleUI
{
    public static class Program
    {
        ...
        public static void Main()
        {
            ...
            // keep the user interface code decoupled from the details of that data access method
            IRestaurantRepository restaurantRepository = dependencies.CreateRestaurantRepository();
            RunUi(restaurantRepository, serializer);
        }

        public static void RunUi(IRestaurantRepository restaurantRepository, XmlSerializer serializer)
        {
